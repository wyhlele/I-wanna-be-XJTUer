...
pub struct Quiz3Plugin;

impl Plugin for Quiz3Plugin{
...
fn spawn_once(
    ...
    spawn_single_savepointer(&mut commands,&sv_image,&sv_atlas,0.,0.,BASEX,BASEY,6);
            ...
            CollisionEvent::Started(entity_a, entity_b, _) => {
                ...
                if is_entity1_b && is_entity2_a || is_entity1_a && is_entity2_b{
                    ...
                    commands.spawn(
                        ...
                        Transform{
                            translation: Vec3::new(BASEX+160., BASEY+32., -0.1),
