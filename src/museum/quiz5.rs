...
pub struct Quiz5Plugin;

impl Plugin for Quiz5Plugin{
...
fn spawn_once(
    ...
    spawn_single_savepointer(&mut commands,&sv_image,&sv_atlas,0.,0.,BASEX,BASEY,8);
        ...
        match collision_event {
            CollisionEvent::Started(entity_a, entity_b, _) => {
                ...
                if is_entity1_b && is_entity2_a || is_entity1_a && is_entity2_b{
                    ...
                    commands.spawn(
                        Sprite{
                            image: quiz_assets.h5.clone(),
                            ..Default::default()
                        },
                    ).insert(
                        Transform{
                            translation: Vec3::new(BASEX+80., BASEY+128., -0.1),
                            scale: Vec3::new(1.,1.,1.),
                            ..Default::default()
                        },
                    ).insert(NeedReload);
