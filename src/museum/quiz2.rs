...
pub struct Quiz2Plugin;

impl Plugin for Quiz2Plugin{
...
fn spawn_once(
    ...
    spawn_single_savepointer(&mut commands,&sv_image,&sv_atlas,0.,0.,BASEX,BASEY,5);
    ...
    let wp3 = spawn_fake_warp(&mut commands,&wr_image,&wr_atlas,BASEX,BASEY-256.);
